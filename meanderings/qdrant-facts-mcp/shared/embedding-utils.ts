/**
 * Embedding utilities for AI Memory MCP
 *
...
import { generateEmbedding as generateEmbeddingClient, cosineSimilarity as cosineSimilarityClient } from './embedding-client.js';
